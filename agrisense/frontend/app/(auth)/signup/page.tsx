  ...
  return password ? (
    <div className="mt-1">
      <div className="flex gap-1 h-1">
        {[1, 2, 3].map(i => (
          <div key={i} className={`flex-1 rounded-full ${i <= strength ? colors[strength] : 'bg-gray-200'}`} />
        ))}
      </div>
...
export default function SignupPage() {
  ...
  const onSubmit = async (data: SignupForm) => {
    ...
    try {
      ...
      toast.success('Account created! Add your first farm.')
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-900 to-primary-600 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <p className="text-gray-500 mb-6">Start getting AI crop recommendations</p>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            <input {...register('confirm', { required: 'Please confirm password' })}
